package ar.edu.um.programacion2.cinemacenter.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("cinemacenter");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("cinemacenter");
        ...
        config.getMapConfigs().put("ar.edu.um.programacion2.cinemacenter.domain.*", initializeDomainMapConfig(jHipsterProperties));
